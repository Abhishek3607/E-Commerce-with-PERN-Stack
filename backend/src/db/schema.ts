// Here all the database tables will be set
...
// cascade = “delete children when parent is deleted”; ex: If a user deletes their account, then delete all the sessions they had.
